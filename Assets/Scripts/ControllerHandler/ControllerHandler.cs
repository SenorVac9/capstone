        ...
        private void HandleControlsUpTo(VehicleBehavior vehicleNumber)
        {
            ...
            if (vehicle1.JoyStick == -1)
            {
                ...
                if (vehicle1.JoyStick > 0)
                {
                    ...
                    vehicle1.input_ItemPrev = "LeftBumper_P" + vehicle1.JoyStick;
                    vehicle1.input_ItemNext = "RightBumper_P" + vehicle1.JoyStick;
            ...
            else if (vehicle2.JoyStick == -1)
            {
                ...
                if (vehicle2.JoyStick > 0)
                {
                    ...
                    vehicle2.input_ItemPrev = "LeftBumper_P" + vehicle2.JoyStick;
                    vehicle2.input_ItemNext = "RightBumper_P" + vehicle2.JoyStick;
            ...
            else if (vehicle3.JoyStick == -1)
            {
                ...
                if (vehicle3.JoyStick > 0)
                {
                    ...
                    vehicle3.input_ItemPrev = "LeftBumper_P" + vehicle3.JoyStick;
                    vehicle3.input_ItemNext = "RightBumper_P" + vehicle3.JoyStick;
            ...
            else if (vehicle4.JoyStick == -1)
            {
                ...
                if (vehicle4.JoyStick > 0)
                {
                    ...
                    vehicle4.input_ItemPrev = "LeftBumper_P" + vehicle4.JoyStick;
                    vehicle4.input_ItemNext = "RightBumper_P" + vehicle4.JoyStick;
