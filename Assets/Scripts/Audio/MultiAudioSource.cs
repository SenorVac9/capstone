...
namespace Assets.MultiAudioListener
{
    public class MultiAudioSource : MonoBehaviour
    {
        ...
        public static MultiAudioSource instance;
        ...
        [Range(0.0f, 20.0f)] [SerializeField] private float _volume = 10.0f; //Play with volume and dont forget to change in VirtualMultiAudioListener as well
